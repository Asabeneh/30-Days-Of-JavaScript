<div align="center">
  ...
  - [Day 10](#day-10)
      - [Set](#set)
          ...
          - [Bir set'e eleman ekleme](#bir-set'e-eleman-ekleme)
          - [Bir elemanı set'den silme](#bir-elemanı-set'den-silme)
          - [Set'deki bir elemanı kontrol etme](#set'deki-bir-elemanı-kontrol-etme)
          - [Set'i temizleme](#set'i-temizleme)
          - [Set'lerin birleşimi](#set'lerin-birleşimi)
          - [Set'lerin kesişimi](#set'lerin-kesişimi)
          - [set'lerin farkı](#set'lerin-farkı)
      - [Map](#map)
          - [Boş map oluşturma](#boş-map-oluşturma)
          - [Bir diziden map oluşturma](#bir-diziden-map-oluşturma)
          - [Map'e değerler ekleme](#map'e-değerler-ekleme)
          - [Map'ten değerler alma](#map'ten-değerler-alma)
